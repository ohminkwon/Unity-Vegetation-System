...
public class ShadowGrassBaker
{
    ...
    public static bool Run(ComputeShader shader, ShadowGrassBakeSettings settings, out Mesh generatedMesh)
    {
        ...
        int numGeneratedVerts = numSourceTriangles * (settings.numBladeSegments * 2 + 1) * 2; // 2 verts per segment, plus the tip
